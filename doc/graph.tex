...
\ifpdf
%\includegraphics{exemploa.pdf}
\else
%\includegraphics{exemploa.eps}
\fi
\subsection{Exemplo B}
2 usuários sem amigos, algumas mensagens entre eles
\ifpdf
%\includegraphics{exemplob.pdf}
\else
%\includegraphics{exemplob.eps}
\fi
\subsection{Exemplo C}
3 usuários ligados, nenhuma mensagem
\ifpdf
%\includegraphics{exemploc.pdf}
\else
%\includegraphics{exemploc.eps}
\fi
